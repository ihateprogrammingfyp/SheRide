...
import { faArrowLeft, faChevronRight } from '@fortawesome/free-solid-svg-icons'; // Importing the required icons
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('SelfieID')} style={styles.button}>
